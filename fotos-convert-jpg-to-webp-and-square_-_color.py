...
# Color de fondo deseado en formato RGB
background_color = (243, 245, 245)
...
for image_file in image_files:
    if image_file.endswith(".jpg"):
        ...
        # Crear una nueva imagen cuadrada con el color de fondo deseado
        new_image = Image.new("RGB", (max_size, max_size), background_color)
