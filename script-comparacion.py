...
# Agregar la columna 'id' de la lista de "Lista Analizar" al resultado
resultado['id'] = lista_analizar['id']

# Seleccionar las columnas requeridas en el resultado
resultado = resultado[['sku', 'rebajado_analizar', 'Precio Normal Correcto', 'Precio Rebajado Correcto', 'id']]
